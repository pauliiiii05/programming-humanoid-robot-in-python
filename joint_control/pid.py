...
class PIDController(object):
    ...
    def control(self, target, sensor):
        ...
        '''
        # YOUR CODE HERE
        currError = target - sensor
        term1 = self.u
        term2 = (self.Kp + self.Ki * self.dt + self.Kd / self.dt) * currError
        term3 = (self.Kp + 2 * self.Kd / self.dt) * self.e1
        term4 = (self.Kd / self.dt) * self.e2

        self.u = term1 + term2 - term3 + term4
